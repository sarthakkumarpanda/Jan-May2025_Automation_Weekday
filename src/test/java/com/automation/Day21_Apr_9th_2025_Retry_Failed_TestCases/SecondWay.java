package com.automation.Day21_Apr_9th_2025_Retry_Failed_TestCases;
...
public class SecondWay {
	...
	//Write your code - Test Cases and let one Test Case fail
	//You need to create another class MyRetry 
...
public WebDriver driver;
	...
	public void verifyLoginWithNoCredentials() {
		...
		String actualWarningMessage = driver.findElement(By.xpath("//div[contains(@class, 'alert-dismissible')]")).getText();
		String expectedWarningMessage = "Warning: No match for E-Mail Address and/or Password.abcdefg";
		//Assert.fail();
